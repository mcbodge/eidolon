...
namespace AC
{
	 ...
	 */
    [System.Serializable]
    public class AC_Trigger_ContinuousWithObjectInHandCheck : ActionList
    {
        ...
        {
            if (triggerType == 1 && IsObjectCorrect(other.gameObject) && ActionHelper.GetManager().HasObjectInHand)
            {
                Interact(other.gameObject);
            }
        }
