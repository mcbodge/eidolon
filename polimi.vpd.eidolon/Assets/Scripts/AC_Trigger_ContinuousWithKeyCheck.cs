...
namespace AC
{
	 ...
	 */
    [System.Serializable]
    public class AC_Trigger_ContinuousWithKeyCheck : ActionList
    {
        ...
        public KeyCode keyCodeToCheck = KeyCode.Space;
        ...
        {
            if (triggerType == 1 && IsObjectCorrect(other.gameObject) && Input.GetKeyDown(keyCodeToCheck))
            {
                Interact(other.gameObject);
            }
        }
