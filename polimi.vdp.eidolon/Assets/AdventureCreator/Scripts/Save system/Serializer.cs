	...
	public class Serializer : MonoBehaviour
	{
		...
		public static int GetConstantID (GameObject _gameObject)
		{
			if (_gameObject.GetComponent <ConstantID>())
			{
				...
				{	
					ACDebug.LogWarning ("GameObject " + _gameObject.name + " was not saved because it does not have an ID.");
				}
			}
			else
			{
				ACDebug.LogWarning ("GameObject " + _gameObject.name + " was not saved because it does not have a constant ID script!");
			}
